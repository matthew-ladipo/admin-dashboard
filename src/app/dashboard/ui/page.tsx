  ...
  return (
    <div>
      <Command className="bg-gray-200">
        <CommandList className="data-[selected='true']:bg-accent">
          <CommandGroup className="py-5  " heading="Digitlaw">
            <CommandItem className="py-[20px] ">
              <MdOutlineDashboard />
              Dashboard
            </CommandItem>
            <CommandItem className="py-[20px]">
          ...
          <CommandGroup >
            ...
            <CommandItem className="py-[10px]">
            <Button variant="outline" className="mt-10">Button</Button>
            </CommandItem>
          </CommandGroup>
        </CommandList>
      </Command>
