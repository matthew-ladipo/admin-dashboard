...
const Side = () => {
  return (
    <div className="bg-gray-200 sm:p-6 lg:p-8">
  <Command className="bg-white shadow-md rounded-lg">
    <CommandList className="data-[selected='true']:bg-accent px-3 sm:px-5 lg:px-6">
      <CommandGroup className="py-1 sm:py-5 lg:py-6 text-gray-500" heading="Digitlaw">
